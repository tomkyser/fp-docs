---
name: fp-docs:ug-audit
description: Audit user guide coverage gaps. Compare user-visible features in codebase against documented pages. Report undocumented features.
...
<workflow>
@${CLAUDE_PLUGIN_ROOT}/workflows/ug-audit.md
</workflow>
...
Execute the workflow from @${CLAUDE_PLUGIN_ROOT}/workflows/ug-audit.md starting at Step 1.
