---
name: fp-docs:ug-generate
description: Generate a new user guide page for a feature or workflow. Analyzes code, discovers UI paths, captures screenshots, and writes content using the appropriate page template.
...
<workflow>
@${CLAUDE_PLUGIN_ROOT}/workflows/ug-generate.md
</workflow>
...
Execute the workflow from @${CLAUDE_PLUGIN_ROOT}/workflows/ug-generate.md starting at Step 1.
