---
name: fp-docs:ug-preview
description: Start local Hugo dev server or trigger preview deploy for user guide on current branch.
...
<workflow>
@${CLAUDE_PLUGIN_ROOT}/workflows/ug-preview.md
</workflow>
...
Execute the workflow from @${CLAUDE_PLUGIN_ROOT}/workflows/ug-preview.md starting at Step 1.
