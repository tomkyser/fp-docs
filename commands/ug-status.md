---
name: fp-docs:ug-status
description: Report user guide health metrics. Shows page counts, screenshot inventory, coverage percentage, staleness, and structural health.
...
<workflow>
@${CLAUDE_PLUGIN_ROOT}/workflows/ug-status.md
</workflow>
...
Execute the workflow from @${CLAUDE_PLUGIN_ROOT}/workflows/ug-status.md starting at Step 1.
