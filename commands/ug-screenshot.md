---
name: fp-docs:ug-screenshot
description: Capture or refresh screenshots for user guide pages. Uses Playwright MCP to navigate WP admin and capture current UI state.
...
<workflow>
@${CLAUDE_PLUGIN_ROOT}/workflows/ug-screenshot.md
</workflow>
...
Execute the workflow from @${CLAUDE_PLUGIN_ROOT}/workflows/ug-screenshot.md starting at Step 1.
