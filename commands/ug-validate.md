---
name: fp-docs:ug-validate
description: Validate user guide accuracy against current UI state. Checks navigation paths, screenshot currency, tone compliance, and content completeness.
argument-hint: '"page path or section" [--depth quick|standard|deep] [--all] [--no-tone-check]'
allowed-tools:
  - Bash
  - Task
---
...
<workflow>
@${CLAUDE_PLUGIN_ROOT}/workflows/ug-validate.md
</workflow>
...
Execute the workflow from @${CLAUDE_PLUGIN_ROOT}/workflows/ug-validate.md starting at Step 1.
