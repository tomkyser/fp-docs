---
name: fp-docs:ug-update
description: Update an existing user guide page after codebase changes. Detects what changed, re-verifies UI paths, and refreshes stale screenshots.
...
<workflow>
@${CLAUDE_PLUGIN_ROOT}/workflows/ug-update.md
</workflow>
...
Execute the workflow from @${CLAUDE_PLUGIN_ROOT}/workflows/ug-update.md starting at Step 1.
