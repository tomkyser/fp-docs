---
name: fp-docs:ug-batch
description: Batch operations across multiple user guide pages. Uses Agent Teams for parallel execution when enabled, falls back to sequential.
...
<workflow>
@${CLAUDE_PLUGIN_ROOT}/workflows/ug-batch.md
</workflow>
...
Execute the workflow from @${CLAUDE_PLUGIN_ROOT}/workflows/ug-batch.md starting at Step 1.
