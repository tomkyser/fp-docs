---
name: docs-mod-validation
description: "Shared module providing the 10-point verification checklist, sanity-check algorithm, and zero-tolerance mode. Preloaded by docs-modify and docs-validate engines. NOT user-invocable."
