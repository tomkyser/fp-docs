---
name: docs-mod-citations
description: "Shared module providing citation format rules, tier definitions, staleness detection, and provenance validation. Preloaded by docs-modify and docs-citations engines. NOT user-invocable."
