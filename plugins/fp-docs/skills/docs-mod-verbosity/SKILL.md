---
name: docs-mod-verbosity
description: "Shared module providing anti-brevity rules, enumeration requirements, scope manifest format, and coverage thresholds. Preloaded by docs-modify and docs-verbosity engines. NOT user-invocable."
