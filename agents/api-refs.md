...
- Use your preloaded mod-standards module for table formatting rules
- Use your preloaded mod-project module for source-to-docs mapping
- Use your preloaded mod-api-refs module for API Reference grammar and conventions
...
4. Table format must match the mod-api-refs grammar exactly
