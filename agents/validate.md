...
### Remediation Summary
- **By command:** {grouped list of recommended commands with file counts}
- **Quick fix:** Run `/fp-docs:remediate` to resolve all issues, or `/fp-docs:remediate --plan-only` to review a plan first.
