 ...
 *
 * The routing table has exactly 21 entries matching the manifest.md Commands table.
...
/**
 * The canonical routing table -- exactly 21 entries matching manifest.md.
...
const ROUTING_TABLE = {
  ...
  'update':          { engine: 'system',      operation: 'update',              type: 'admin' },
};
