 ...
 * system, index, verbosity are administrative/standalone -- no phase authority mapping needed.
 */
 ...
 *
 * @param {string} agentType - Engine/agent identifier (e.g., 'modify', 'validate')
