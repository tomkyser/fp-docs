 ...
 *   - project: FP-specific paths, appendix triggers, repo configuration
 *   - pipeline: 8-stage pipeline definition with phase/agent/skip rules
 *
 * Note: Source-to-doc mapping has been extracted to `lib/source-map.cjs`
 * and `source-map.json`. Use source-map.cjs for all mapping lookups.
 *
